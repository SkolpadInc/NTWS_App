      ...
      <div class="card-content row">
        ...
        <div class="col-sm-6">
          <div class="pull-right">
            <br>
            <label>
              <input type="search" class="form-control input-sm" placeholder="Search account" v-model="searchQuery" aria-controls="datatables">
            </label>
          </div>
        </div>
        <div class="col-sm-12">
        ...
        <div class="col-sm-6 pagination-info">
          <br>
          <p class="category">Showing {{from + 1}} to {{to}} of {{total}} accounts</p>
        </div>
        <div class="col-sm-6">
